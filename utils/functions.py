...
def get_model(field_name_id):
    ...
    elif field_name_id == 'event_type_id':
    ...
    elif field_name_id == 'mip_control_form_id':
    ...
    elif field_name_id == 'mip_signature_form_id':
        return [MIPSignatureForm, 'formulario de firma MIP']
